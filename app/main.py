...
from app.api.routers import auth, department, user, petition, task, project, upload, admin, ai, dashboard, knowledge, chat, notification, chat_ws, announcement, home
